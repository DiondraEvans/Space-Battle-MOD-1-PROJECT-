...
class Alienfleet {
 ...
 addShip(shipname, hull, firepower, accuracy){
       this.ships.push(new Ship (shipname, 
...
let myshipimgdestroyed = document.getElementById("myshipimgdestroyed")
        ...
        if (me.hull <= 0){
            ...
            while (keepLooping){
                if (me.accuracy > Math.random()){
                    ...
                    //added switch cases to each event that sends an object back to the method to reflect updated stats
                    switch (alienfleet1.ships[i].shipname){
                        case "Alien ship 1":
